...
namespace Shooting
{
    public class Level3 : IScene
    {
        ...
        public Level3 (Game1 game, GraphicsDeviceManager graphics, ContentManager content)
        {
            this.game = game;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(playFont, "Scores Needed: 15", new Vector2(10, 70), Color.Black);
        }
