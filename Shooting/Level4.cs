...
namespace Shooting
{
    public class Level4 : IScene
    {
        ...
        private int score = 0;
        private double timer = 19;

        private SoundEffect hitSound;
        private SoundEffect missSound;

        // Gets or sets the type of scene requested to transition to.
        public GameSceneType? RequestedScene { get; private set; }

        // Initializes a new instance of the.
        public Level4 (Game1 game, GraphicsDeviceManager graphics, ContentManager content)
        {
            this.game = game;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(playFont, "Scores Needed: 20 ", new Vector2(10, 70), Color.Black);
        }
